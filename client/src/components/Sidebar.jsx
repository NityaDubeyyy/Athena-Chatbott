...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* New Chat */}
      <button className="mt-4 flex items-center text-sm font-medium px-3 py-2 border border-gray-400 dark:border-white/20 rounded-md hover:bg-white/10 transition-all">
